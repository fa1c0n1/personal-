...
public class ConfigMapPrecondition implements Condition<ConfigMap, CoreResource> {

    @Override
    public boolean isMet(final DependentResource<ConfigMap, CoreResource> dependentResource, final CoreResource primary, final Context<CoreResource> context) {
