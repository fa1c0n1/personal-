...
@SuppressWarnings({
        ...
        "deprecation" // TODO This class is an override from OSS version; Need to think of an alternate path
})
public class CassandraIO {
    ...
    public abstract static class Read<T> extends PTransform<PBegin, PCollection<T>> {
        ...
        /** Changes with respect to Support ACI Cassandra */
        abstract @Nullable
        ValueProvider<Boolean> isVanilla();

        abstract @Nullable
        ValueProvider<String> applicationName();

        abstract @Nullable
        ValueProvider<String> clusterName();

        abstract @Nullable
        ValueProvider<String> discoveryUrl();

        abstract @Nullable
        ValueProvider<String> trustStoreLocation();

        abstract @Nullable
        ValueProvider<String> trustStorePassword();
        /** End of ACI Cassandra changes Block */
        ...
        /** Changes with respect to Support ACI Cassandra */
        /**
         * Specify the applicationName of the Apache Cassandra instances.
         */
        public Read<T> withVanillaCassandra(boolean isVanilla) {
            return builder().setIsVanilla(ValueProvider.StaticValueProvider.of(isVanilla)).build();
        }

        /**
         * Specify the applicationName of the Apache Cassandra instances.
         */
        public Read<T> withApplicationName(String applicationName) {
            checkArgument(applicationName != null, "Application Name can not be null");
            return builder().setApplicationName(ValueProvider.StaticValueProvider.of(applicationName)).build();
        }

        /**
         * Specify the Discovery Url of the Apache Cassandra instances.
         */
        public Read<T> withDiscoveryUrl(String discoveryUrl) {
            checkArgument(discoveryUrl != null, "Discovery Url can not be null");
            return builder().setDiscoveryUrl(ValueProvider.StaticValueProvider.of(discoveryUrl)).build();
        }

        /**
         * Specify the clusterName of the Apache Cassandra instances.
         */
        public Read<T> withClusterName(String clusterName) {
            checkArgument(clusterName != null, "Cluster Name can not be null");
            return builder().setClusterName(ValueProvider.StaticValueProvider.of(clusterName)).build();
        }

        /**
         * Specify the Trust Store Location of the Apache Cassandra instances.
         */
        public Read<T> withTrustStoreLocation(String trustStoreLocation) {
            checkArgument(trustStoreLocation != null, "Trust Store Location can not be null");
            return builder().setTrustStoreLocation(ValueProvider.StaticValueProvider.of(trustStoreLocation)).build();
        }

        /**
         * Specify the Trust Store Password of the Apache Cassandra instances.
         */
        public Read<T> withTrustStorePassword(String trustStorePassword) {
            checkArgument(trustStorePassword != null, "Trust Store Location can not be null");
            return builder().setTrustStorePassword(ValueProvider.StaticValueProvider.of(trustStorePassword)).build();
        }
        /** End of ACI Cassandra changes Block */
        ...
        public PCollection<T> expand(PBegin input) {
            ...
            if(isVanilla().get()) {
                ...
                checkArgument((discoveryUrl() != null && port() != null), "discoveryUrl() and withPort() are required");
            }
            /** End of ACI Cassandra changes Block */
        ...
        private static class SplitFn<T> extends DoFn<Read<T>, Read<T>> {
            ...
            private static <T> Set<RingRange> getRingRanges(Read<T> read) {
                /** Changes with respect to Support ACI Cassandra */
                try (Cluster cluster = (read.isVanilla().get() ?
                        getCluster(
                                read.hosts(),
                                read.port(),
                                read.username(),
                             ...
                             getCluster(
                                     ...
                                     read.clusterName(),
                                     read.discoveryUrl(),
                                     read.trustStoreLocation(),
                                     read.trustStorePassword()))) {
                    /** End of ACI Cassandra changes Block */
        ...
        abstract static class Builder<T> {
            /** Changes with respect to Support ACI Cassandra */
            abstract Builder<T> setIsVanilla(ValueProvider<Boolean> isVanilla);

            abstract Builder<T> setApplicationName(ValueProvider<String> applicationName);

            abstract Builder<T> setClusterName(ValueProvider<String> clusterName);

            abstract Builder<T> setDiscoveryUrl(ValueProvider<String> discoveryUrl);

            abstract Builder<T> setTrustStoreLocation(ValueProvider<String> trustStoreLocation);

            abstract Builder<T> setTrustStorePassword(ValueProvider<String> trustStorePassword);
            /** End of ACI Cassandra changes Block */
    ...
    public abstract static class Write<T> extends PTransform<PCollection<T>, PDone> {
         ...
         * Specify the applicationName of the Apache Cassandra instances.
         */
        public Write<T> withVanillaCassandra(boolean isVanilla) {
            return builder().setIsVanilla(ValueProvider.StaticValueProvider.of(isVanilla)).build();
        }
         ...
         * Specify the applicationName of the Apache Cassandra instances.
         */
        public Write<T> withApplicationName(String applicationName) {
            checkArgument(applicationName != null, "Application Name can not be null");
            return builder().setApplicationName(ValueProvider.StaticValueProvider.of(applicationName)).build();
        }
         ...
         * Specify the Discovery Url of the Apache Cassandra instances.
         */
        public Write<T> withDiscoveryUrl(String discoveryUrl) {
            checkArgument(discoveryUrl != null, "Discovery Url can not be null");
            return builder().setDiscoveryUrl(ValueProvider.StaticValueProvider.of(discoveryUrl)).build();
        }
         ...
         * Specify the clusterName of the Apache Cassandra instances.
         */
        public Write<T> withClusterName(String clusterName) {
            checkArgument(clusterName != null, "Cluster Name can not be null");
            return builder().setClusterName(ValueProvider.StaticValueProvider.of(clusterName)).build();
        }
         ...
         * Specify the Trust Store Location of the Apache Cassandra instances.
         */
        public Write<T> withTrustStoreLocation(String trustStoreLocation) {
            checkArgument(trustStoreLocation != null, "Trust Store Password can not be null");
            return builder().setTrustStoreLocation(ValueProvider.StaticValueProvider.of(trustStoreLocation)).build();
        }
         ...
         * Specify the Trust Store Password of the Apache Cassandra instances.
         */
        public Write<T> withTrustStorePassword(String trustStorePassword) {
            checkArgument(trustStorePassword != null, "Trust Store Password can not be null");
            return builder().setTrustStorePassword(ValueProvider.StaticValueProvider.of(trustStorePassword)).build();
        }
    ...
    /** Changes with respect to Support ACI Cassandra */
    /**
     * Get a ACI Cassandra cluster using casserolle Url.
     */
    static CassandraCluster getCluster(
            ValueProvider<Integer> port,
            ValueProvider<String> username,
            ValueProvider<String> password,
            ValueProvider<String> localDc,
        ...
        CassandraCluster.Builder builder = CassandraCluster.builder();
        builder.withApplication(applicationName.get());
        builder.withClusterName(clusterName.get());
        builder.withCasseroleOptions((new CasseroleOptions()).setCasseroleURI(discoveryUrl.get()));
        builder.withPort(port.get());
        builder.withSSL(trustStoreLocation.get(), trustStorePassword.get());
        builder.withDataCenter(localDc.get());
        PlainTextAuthProvider authProvider = new PlainTextAuthProvider(username.get(),
                password.get());
            ...
            this.cluster =
                    ...
                    (spec.isVanilla().get() ?
                            ...
                            getCluster(
                                    ...
                                    spec.clusterName(),
                                    spec.discoveryUrl(),
                                    spec.trustStoreLocation(),
                                    spec.trustStorePassword()));
            this.session = spec.isVanilla().get() ?
                    cluster.connect(Objects.requireNonNull(spec.keyspace()).get())
                    : cluster.connect();
            /** End of ACI Cassandra changes Block */
