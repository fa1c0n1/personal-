...
import com.apple.aml.stargate.pipeline.sdk.ts.BaseJavaFunction;
import org.apache.avro.generic.GenericRecord;
import org.apache.flink.api.java.tuple.Tuple2;
import org.apache.flink.streaming.api.functions.ProcessFunction;
import org.apache.flink.util.Collector;

public class JavaMapFunction extends ProcessFunction<Tuple2<String, GenericRecord>, Tuple2<String, GenericRecord>> {

    private BaseJavaFunction baseJavaFunction;

    private StargateNode node;

    private JavaFunctionOptions evaluatorOptions;

    public JavaMapFunction(StargateNode node, JavaFunctionOptions evaluatorOptions ){
        this.node=node;
    ...
    public void open(org.apache.flink.configuration.Configuration parameters) throws Exception {
        ...
        baseJavaFunction = new BaseJavaFunction(FlinkUtils.nodeService(), FlinkUtils.errorService());
        baseJavaFunction.initJavaFunctionNode(node,evaluatorOptions);
    }
    ...
    public void processElement(Tuple2<String, GenericRecord> value, ProcessFunction<Tuple2<String, GenericRecord>, Tuple2<String, GenericRecord>>.Context ctx, Collector<Tuple2<String, GenericRecord>> out) throws Exception {
        baseJavaFunction.processElement(FlinkUtils.convertToKV(value),  skv -> {
