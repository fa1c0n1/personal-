...
public class JdbcOperations extends FreemarkerEvaluator implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = logger(MethodHandles.lookup().lookupClass());
    private JdbiOptions options;
    ...
    public void initTransform(final Pipeline pipeline, final StargateNode node) throws Exception {
        ...
        this.options = duplicate(node.getConfig(), JdbiOptions.class);
    }
    ...
    public Pair<String, Object> bean() {
        return Pair.of("client", jdbiService(nodeName, options));
    }
}
